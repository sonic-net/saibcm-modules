...
/*! Module information */
#define NGKNET_MODULE_NAME      "linux-ngknet"
#define NGKNET_MODULE_MAJOR     123

/*! Must be updated if backward compatibility is broken */
#define NGKNET_IOC_VERSION      3
...
#define NGKNET_MESSAGE          _IOWR(NGKNET_IOC_MAGIC, 0x80, unsigned int)
