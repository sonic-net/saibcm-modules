...
bcmcnet_pdma_info_get(struct pdma_dev *dev)
{
    ...
    dev->info.rx_ph_size = dev->rx_ph_size;
    dev->info.tx_ph_size = dev->tx_ph_size;
...
bcmcnet_pdma_open(struct pdma_dev *dev)
{
    ...
    dev->rx_ph_size = dev->rx_ph_size ? dev->rx_ph_size : hw->info.rx_ph_size;
    dev->tx_ph_size = dev->tx_ph_size ? dev->tx_ph_size : hw->info.tx_ph_size;
