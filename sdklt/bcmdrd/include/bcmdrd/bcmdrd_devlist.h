...
#if BCMDRD_CONFIG_INCLUDE_BCM78800_A1 == 1 || defined(BCMDRD_DEVLIST_OVERRIDE)
#ifdef BCMDRD_DEVLIST_INCLUDE_ALL
BCMDRD_DEVLIST_ENTRY(BCM78800, BCM78800_VENDOR_ID, BCM78800_DEVICE_ID, BCM78800_REV_A1, \
                     0, 0, \
                     bcm78800_a0, bcm78800_a0, bcm78800_a1, \
                     "Trident5", "BCM78800", \
                     "16 Tbps Programmable Switch", 0, 0)
#endif
#endif
...
#if BCMDRD_CONFIG_INCLUDE_BCM78808_A1 == 1 || defined(BCMDRD_DEVLIST_OVERRIDE)
#ifdef BCMDRD_DEVLIST_INCLUDE_ALL
BCMDRD_DEVLIST_ENTRY(BCM78808, BCM78808_VENDOR_ID, BCM78808_DEVICE_ID, BCM78808_REV_A1, \
                     0, 0, \
                     bcm78800_a0, bcm78808_a0, bcm78808_a1, \
                     "Trident5", "BCM78800", \
                     "8 Tbps Programmable Switch", 0, 0)
#endif
#endif
...
#if BCMDRD_CONFIG_INCLUDE_BCM78920_B0 == 1 || defined(BCMDRD_DEVLIST_OVERRIDE)
BCMDRD_DEVLIST_ENTRY(BCM78920, BCM78920_VENDOR_ID, BCM78920_DEVICE_ID, BCM78920_REV_B0, \
                     0, 0, \
                     bcm78920_b0, bcm78920_b0, bcm78920_b0, \
                     "Tomahawk Ultra", "BCM78920", \
                     "51.2 Tbps Multilayer Switch", 0, 0)
#endif
...
#if BCMDRD_CONFIG_INCLUDE_BCM78923_B0 == 1 || defined(BCMDRD_DEVLIST_OVERRIDE)
#ifdef BCMDRD_DEVLIST_INCLUDE_ALL
BCMDRD_DEVLIST_ENTRY(BCM78923, BCM78923_VENDOR_ID, BCM78923_DEVICE_ID, BCM78923_REV_B0, \
                     0, 0, \
                     bcm78920_b0, bcm78923_b0, bcm78923_b0, \
                     "Tomahawk Ultra", "BCM78920", \
                     "25.6 Tbps Multilayer Switch", 0, 0)
#endif
#endif
...
#if BCMDRD_CONFIG_INCLUDE_BCM78924_B0 == 1 || defined(BCMDRD_DEVLIST_OVERRIDE)
#ifdef BCMDRD_DEVLIST_INCLUDE_ALL
BCMDRD_DEVLIST_ENTRY(BCM78924, BCM78924_VENDOR_ID, BCM78924_DEVICE_ID, BCM78924_REV_B0, \
                     0, 0, \
                     bcm78920_b0, bcm78924_b0, bcm78924_b0, \
                     "Tomahawk Ultra", "BCM78920", \
                     "25.6 Tbps Multilayer Switch", 0, 0)
#endif
#endif
...
#if BCMDRD_CONFIG_INCLUDE_BCM78928_B0 == 1 || defined(BCMDRD_DEVLIST_OVERRIDE)
#ifdef BCMDRD_DEVLIST_INCLUDE_ALL
BCMDRD_DEVLIST_ENTRY(BCM78928, BCM78928_VENDOR_ID, BCM78928_DEVICE_ID, BCM78928_REV_B0, \
                     0, 0, \
                     bcm78920_b0, bcm78928_b0, bcm78928_b0, \
                     "Tomahawk Ultra", "BCM78920", \
                     "51.2 Tbps Multilayer Switch", 0, 0)
#endif
#endif
