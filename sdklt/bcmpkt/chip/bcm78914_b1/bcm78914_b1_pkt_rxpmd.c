 ...
 *
 * This file provides RXPMD access functions for BCM78914_B1.
 *
 ******************************************************************************/
 ...
 * SIZE:     51
 ******************************************************************************/
void bcm78914_b1_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
...
void bcm78914_b1_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
    uint32_t val;
 ...
 * SIZE:     64
 ******************************************************************************/
void bcm78914_b1_ep_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
...
void bcm78914_b1_ep_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
    uint32_t val;
    COMPILER_REFERENCE(val);
    if (data[1] & (0x1 << 0)) {
...
const bcmpkt_rxpmd_fget_t bcm78914_b1_rxpmd_fget = {
    {
...
const bcmpkt_rxpmd_fset_t bcm78914_b1_rxpmd_fset = {
    {
...
const bcmpkt_rxpmd_figet_t bcm78914_b1_rxpmd_figet = {
    {
...
static shr_enum_map_t bcm78914_b1_rxpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm78914_b1_rxpmd_view_infos[BCMPKT_RXPMD_FID_COUNT] = {
...
void bcm78914_b1_rxpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78914_b1_rxpmd_view_infos;
    info->view_types = bcm78914_b1_rxpmd_view_types;
