 ...
 *
 * This file provides LBHDR access functions for BCM78914_B0.
 *
 ******************************************************************************/
...
const bcmpkt_lbhdr_fget_t bcm78914_b0_lbhdr_fget = {
    {
...
const bcmpkt_lbhdr_fset_t bcm78914_b0_lbhdr_fset = {
    {
...
const bcmpkt_lbhdr_figet_t bcm78914_b0_lbhdr_figet = {
    {
        bcmpkt_lbhdr_i_size_get
    }
};

static shr_enum_map_t bcm78914_b0_lbhdr_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm78914_b0_lbhdr_view_infos[BCMPKT_LBHDR_FID_COUNT] = {
...
void bcm78914_b0_lbhdr_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78914_b0_lbhdr_view_infos;
    info->view_types = bcm78914_b0_lbhdr_view_types;
