 ...
 *
 * This file provides TXPMD access functions for BCM78914_B0.
 *
 ******************************************************************************/
...
const bcmpkt_txpmd_fget_t bcm78914_b0_txpmd_fget = {
    {
...
const bcmpkt_txpmd_fset_t bcm78914_b0_txpmd_fset = {
    {
...
const bcmpkt_txpmd_figet_t bcm78914_b0_txpmd_figet = {
    {
        bcmpkt_txpmd_i_size_get
    }
};

static shr_enum_map_t bcm78914_b0_txpmd_view_types[] = {
    {"sobmh_from_cpu", 1},
    {"cpu_tx", 2},
    {NULL, -1},
};
...
static int bcm78914_b0_txpmd_view_infos[BCMPKT_TXPMD_FID_COUNT] = {
...
void bcm78914_b0_txpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78914_b0_txpmd_view_infos;
    info->view_types = bcm78914_b0_txpmd_view_types;
