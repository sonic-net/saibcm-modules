 ...
 * 
 *
 * This file provides TXPMD access functions for BCM99470_A0.
 *
 ******************************************************************************/
...
const bcmpkt_txpmd_fset_t bcm99470_a0_txpmd_fset = {
    {
     bcmpkt_txpmd_start_set,
     NULL,
     bcmpkt_txpmd_pkt_length_set,
...
const bcmpkt_txpmd_figet_t bcm99470_a0_txpmd_figet = {
    {
     bcmpkt_txpmd_i_size_get}
};

static shr_enum_map_t bcm99470_a0_txpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm99470_a0_txpmd_view_infos[BCMPKT_TXPMD_FID_COUNT] = {
...
void
bcm99470_a0_txpmd_view_info_get(
    bcmpkt_pmd_view_info_t * info)
{
    info->view_infos = bcm99470_a0_txpmd_view_infos;
    info->view_types = bcm99470_a0_txpmd_view_types;
